...
/**
 * A mutation to create a match overlay. Requires tournament access.
 */
...
/**
 * A mutation to create a card overlay. Requires tournament access.
 */
...
/**
 * A mutation to create a commentary overlay. Requires tournament access.
 */
...
/**
 * A query to get an overlay by public UUID. No authentication required.
 */
